...
/*
  ...
  structure because the safe_Mutex structure could be freed before
...
int safe_mutex_init(safe_Mutex *mp, const pthread_mutexattr_t *attr,
                    const char *file, uint line);
int safe_mutex_lock(safe_Mutex *mp, my_bool try_lock, const char *file, uint line);
int safe_mutex_unlock(safe_Mutex *mp,const char *file, uint line);
int safe_mutex_destroy(safe_Mutex *mp,const char *file, uint line);
int safe_cond_wait(pthread_cond_t *cond, safe_Mutex *mp,const char *file,
		   uint line);
int safe_cond_timedwait(pthread_cond_t *cond, safe_Mutex *mp,
                        const struct timespec *abstime,
                        const char *file, uint line);
...
typedef struct st_my_pthread_fastMutex
{
  pthread_mutex_t mutex;
  uint spins;
  uint rng_state;
...
int my_pthread_fastmutex_init(my_pthread_fastMutex *mp, 
                              const pthread_mutexattr_t *attr);
int my_pthread_fastmutex_lock(my_pthread_fastMutex *mp);
...
struct st_my_thread_var
{
  ...
  mysql_Mutex mutex;
  mysql_Mutex * volatile current_mutex;
