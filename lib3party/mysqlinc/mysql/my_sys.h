...
{
  mysql_Mutex       mutex;           /* To sync on reads into buffer. */
...
typedef struct st_io_cache		/* Used when cacheing files */
{
  ...
  */
  mysql_Mutex append_buffer_lock;
  /*
...
#ifdef __WIN__
extern my_bool isFilename_allowed(const char *name, size_t length,
                   my_bool allow_current_dir);
#else /* __WIN__ */
# define isFilename_allowed(name, length, allow_cwd) (TRUE)
#endif /* __WIN__ */ 
