...
/**
  State data storage for @c get_threadFile_name_locker_v1_t.
  This structure provide temporary storage to a file locker.
  The content of this structure is considered opaque,
  the fields are only hints of what an implementation
  of the psi interface can use.
  This memory is provided by the instrumented code for performance reasons.
  @sa get_threadFile_name_locker_v1_t
  @sa get_threadFile_stream_locker_v1_t
  @sa get_threadFile_descriptor_locker_v1_t
*/
...
typedef void (*register_socket_v1_t)
  (const char *category, struct PSI_SocketInfo_v1 *info, int count);
...
*/
typedef struct PSI_file_locker* (*get_threadFile_name_locker_v1_t)
...
/**
  ...
  @return a file locker, or NULL
*/
typedef struct PSI_file_locker* (*get_threadFile_stream_locker_v1_t)
  (struct PSI_file_locker_state_v1 *state,
...
/**
  ...
  @return a file locker, or NULL
*/
typedef struct PSI_file_locker* (*get_threadFile_descriptor_locker_v1_t)
  (struct PSI_file_locker_state_v1 *state,
...
/**
  ...
  @sa get_threadFile_name_locker
  @sa get_threadFile_stream_locker
  @sa get_threadFile_descriptor_locker
*/
...
*/
typedef void (*set_SocketInfo_v1_t)(struct PSI_socket *socket,
                                     const my_socket *fd,
...
struct PSI_v1
{
  ...
  /** @sa get_threadFile_name_locker_v1_t. */
  get_threadFile_name_locker_v1_t get_threadFile_name_locker;
  /** @sa get_threadFile_stream_locker_v1_t. */
  get_threadFile_stream_locker_v1_t get_threadFile_stream_locker;
  /** @sa get_threadFile_descriptor_locker_v1_t. */
  get_threadFile_descriptor_locker_v1_t get_threadFile_descriptor_locker;
  ...
  /** @sa set_SocketInfo_v1_t. */
  set_SocketInfo_v1_t set_SocketInfo;
...
typedef struct PSI_SocketInfo_v1 PSI_SocketInfo;
...
typedef struct PSI_SocketInfo_v2 PSI_SocketInfo;
