...
{
    m_tq->produce(TaskBinder::gen(&SocketWin::close_impl, this));
}
...
int SocketWin::handleEpollRead()
{
    ...
    if (is_open())
    {
        ...
        else
        {
            ...
            m_tq->produce(TaskBinder::gen(&SocketWin::post_recv_msg, this, tmpdata));
        }
    }
    return 0;
}
...
int SocketWin::handleEpollRead()
{
    m_tq->produce(TaskBinder::gen(&SocketWin::handleEpollRead_impl, this));
    return 0;
}
#endif
...
{
    m_tq->produce(TaskBinder::gen(&SocketWin::handleEpollWrite_impl, this));
    return 0;
}
...
{
    m_tq->produce(TaskBinder::gen(&SocketWin::send_str_impl, this, msg_));
}
